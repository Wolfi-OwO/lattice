...
const DATABASE_NEEDS_URL = {{databaseNeedsUrl}};

function databaseUrl() {
  if (!DATABASE_NEEDS_URL) return null;
...
export const config = {
  ...
  /**
   * Consumed only by src/database. Each adapter reads the keys it cares about and
