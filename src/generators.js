...
export const GENERATORS = [
  ...
  },
  {
    ...
    requires: 'composer',
    bin: 'composer',
    argv: (name) => ['create-project', 'laravel/laravel', name, '--no-interaction'],
  ...
  },
  {
    ...
    requires: 'swift',
    bin: 'swift',
    // swift package init writes into the current directory rather than creating one.
    argv: () => ['package', 'init', '--type', 'executable'],
    inProjectDir: true,
    next: ['swift run'],
  },
  {
