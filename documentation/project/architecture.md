---
title: 'Architecture'
edit_url: https://github.com/Wolfi-OwO/lattice/edit/main/ARCHITECTURE.md
---

!!! info "Mirrored from the repository"

    This page is [`ARCHITECTURE.md`](https://github.com/Wolfi-OwO/lattice/blob/main/ARCHITECTURE.md), rendered here. It is generated
...
[ADR-0002](./adr/0002-not-an-enterprise-layered-app.md).
...
- **Zero runtime dependencies** — [ADR-0001](./adr/0001-zero-dependency-core.md).
