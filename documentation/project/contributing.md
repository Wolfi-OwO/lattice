---
title: 'Contributing'
edit_url: https://github.com/Wolfi-OwO/lattice/edit/main/CONTRIBUTING.md
---

!!! info "Mirrored from the repository"

    This page is [`CONTRIBUTING.md`](https://github.com/Wolfi-OwO/lattice/blob/main/CONTRIBUTING.md), rendered here. It is generated
...
(under `stacks/`), not in the CLI. See [ADR-0001](./adr/0001-zero-dependency-core.md).
